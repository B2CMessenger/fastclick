;(function () {
	...
	*/
	...
	FastClick.prototype.needsClick = function(target) {
		...
		return (/\b(needsclick|pac-item|pac-item-query|pac-matched)\b/).test(target.className);
	};
	...
	FastClick.notNeeded = function(layer) {
		...
		if (chromeVersion) {
			...
			if (deviceIsAndroid) {
				...
				if (metaViewport) {
					if (chromeVersion > 33 && (metaViewport.content.indexOf('user-scalable=no') !== -1 || document.documentElement.scrollWidth <= window.outerWidth)) {
    						return true;
					}
				}
